...
public class ConfigHandler {
	...
	public static boolean containsWorldVariable(LobbyWorld lw, String key) {
		return config.contains("Worlds." + lw.getSaveName() + "." + key);
	}

	public static void setWorldVariable(LobbyWorld lw, String key, Object value) {
		config.set("Worlds." + lw.getSaveName() + "." + key, value);
		try {
			config.save(file);
		} catch (IOException e) {
			e.printStackTrace();
